                ...
                <center>
                    <div class="container">
                        <div class="page-header pb-5">
                            <h1><f:message key="404.pageTitle" /></h1>
                            <h3><f:message key="404.pageSubTitle" /></h3>
                        </div>
                        <div class="page-content">
                            <h4><f:message key="404.suggestions" /></h4>
                            <ul  class="list-unstyled">
                                <li>•<f:message key="404.suggestions.1" /></li>
                                <li>•<f:message key="404.suggestions.2" /></li>
                                <li>•<f:message key="404.suggestions.3" /></li>
                            </ul>
                        </div>    
                    </div>
                </center>
